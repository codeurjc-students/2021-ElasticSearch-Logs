...
export class TableComponent implements OnInit {
    ...
    public constructor(
        ...
        this.defaultColDef = {
            ...
            cellRenderer: (params: any) => {
                return params.value != undefined || null
                    ? params.value
                    : params.value;
            },
            cellStyle: {
    ...
    ngOnInit(): void {
        this.managerComunicationService.colDefsObservable.subscribe(
            (data) => {
                this.updateColDefs(data);
            }
        );

        this.managerComunicationService.queryFilterObservable.subscribe(
            (data) => {
        ...
        this.managerComunicationService.fontSizeObservable.subscribe(
            (data) => {
                this.changeFontSize(data);
            }
        );

        this.managerComunicationService.rangeFiltersObservable.subscribe(
            (data) => {
